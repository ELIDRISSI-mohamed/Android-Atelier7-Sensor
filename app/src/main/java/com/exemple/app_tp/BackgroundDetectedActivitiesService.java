...
public class BackgroundDetectedActivitiesService extends Service {
    ...
    public void requestActivityUpdatesButtonHandler() {
        ...
        task.addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void result) {
                Toast.makeText(getApplicationContext(),
                        "Mises à jour d'activité demandées avec succès",
                        Toast.LENGTH_SHORT)
                        .show();
            }
        });
        ...
        task.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(getApplicationContext(),
                        "La demande de mises à jour d'activité n'a pas pu démarrer",
                        Toast.LENGTH_SHORT)
                        .show();
            }
        });
    ...
    public void removeActivityUpdatesButtonHandler() {
        ...
        task.addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void result) {
                Toast.makeText(getApplicationContext(),
                        "Mises à jour d'activité supprimées avec succès !",
                        Toast.LENGTH_SHORT)
                        .show();
            }
        });
        ...
        task.addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(getApplicationContext(), "Échec de la suppression des mises à jour d'activité!",
